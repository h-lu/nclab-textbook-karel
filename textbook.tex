...
\noindent
Note: This is slightly different from how lists are parsed in Python. 
Soon it will be possible to use the Python way in Karel. Implementation is under way.
...
\noindent
The following 
sample program tells the robot to... UNDER CONSTRUCTION

\subsection[\ \ Double indices]{Double indices}

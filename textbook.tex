...
\newpage
\noindent
You can clone this project by typing "karel statistics" in the Search
window. The project is called "Karel and Statistics". Fig. \ref{fig:binomial2}
shows the result. The distribution of the gems along the South wall 
